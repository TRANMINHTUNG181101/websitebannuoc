			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-7 col-md-6 col-sm-6 col-4">
						<span class="t-14">ĐỊA CHỈ: Đ. Lê Lợi, Phường Bến Thành, Quận 1, Thành phố Hồ Chí Minh - 033 420 2221</span>
					</div>
					<div class="col-lg-5 col-md-6 col-sm-6 col-8">
						<div class="topbar_menu">
							<ul>
								<li><a href="order-tracking.html"><i class="fab fa-youtube"></i>Youtube</a></li>
								<li class="hide-m"><a href="wishlist.html"><i class="fas fa-heart"></i>Yêu thích</a></li>
							</ul>
						</div>
					</div>
						...
						<nav id="navigation" class="navigation navigation-landscape">
							...
							<div class="nav-menus-wrapper" style="transition-property: none;">
								<ul class="nav-menu">
									...
									<li><a href="{{ route('get.posts')}}">Tin tức<span class="submenu-indicator"></span></a>


									</li>

									<li><a href="{{ route('about')}}">Cửa hàng<span class="submenu-indicator"></span></a>
						...
						<div class="general_head_right">
							<ul>
								...
								@if(get_user('customer'))
									<i class="fas fa-user-circle mgr-10"></i><h6 class="text-user text-overflow">{{ (get_user('customer','ten')) ? get_user('customer','ten') : 'Khách hàng' }}</h6>
								@else 
								<i class="fas fa-user-circle"></i> <h6 class=" text-user text-overflow">Đăng nhập</h6>
								...
								<i class="fas fa-times dropexit"></i>
									<ul>
										...
										<a class="ml-2" href=" {{ route('get.infouser')}}">Thông tin tài khoản</a>
										</li>
										<li>
								...
								<li><a class="border-icon" href="javascript:void(0);" onclick="openRightMenu()"><i class="fas fa-cart-plus"></i><span class="cart_counter">
							...
							<div class="login_flex">
								...
								<div class="login_flex_2">
									<div class="form-group mb-0">
										<button type="submit" id="loginAcc" class="btn btn-md btn-theme">Đăng nhập</button>
									</div>
								</div>
							</div>
