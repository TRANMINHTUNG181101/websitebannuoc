						...
						<div class="col-lg-10 col-md-12 col-sm-12">
							...
							<div class="card py-3 mt-sm-3">
							  <div class="card-body text-center">
								...
								<p class="font-size-sm mb-2">Đơn hàng của bạn đã được đặt và sẽ được xử lý trong thời gian sớm nhất.</p>
								<p class="font-size-sm mb-2">Đảm bảo bạn ghi lại số đơn đặt hàng của mình, đó là <span class="font-weight-medium">
									@if(isset($madh))
									{{$madh}}
									@endif
								</span></p>
