...
<div class="col-lg-6 col-md-12 col-sm-12">
    <div class="woo_pr_detail">
        ...
        <div class="woo_btn_action">
            <div class="col-12 col-lg-auto">
                <button type="submit" id="updateCart" data-key="{{$keyCart}}" data-id="{{$product->id}}" class="btn btn-block btn-dark mb-2">Thay đổi <i class="fas fa-shopping-basket ml-2"></i></button>
            </div>
            <div class="col-12 col-lg-auto">
